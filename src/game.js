...
export class Game {
  ...
  snapshot() {
    ...
    s.beers = this.beers;
    s.health = this.health.getCurrent();
    s.poopCounter = this.poopManager?.counter || 0;
    s.poopCooldown = this.poopManager?.cooldown || 5;
    s.coffeeBoost = this.coffeeBoostTimer || 0;
    return s;
  }
